 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://richard.com/", wsdlLocation = "http://localhost:8080/SOAP_myApp/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://richard.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SOAP_myApp/ws/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://richard.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://richard.com/", "HelloPort"), Hello.class, features);
    }
